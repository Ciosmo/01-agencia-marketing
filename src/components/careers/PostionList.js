...
function PositionList(){
    return(
        <div className="max-w-full mx-12 bg-white">
            ...
            <p className="text-2xl font-regular text-gray-900 max-w-5xl leading-10">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sint, doloribus tempora architecto dicta accusantium ex.</p> 
